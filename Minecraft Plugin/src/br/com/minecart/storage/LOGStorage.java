...
public class LOGStorage {
	public static void resgatarVIP(String a){
		try {
			FileWriter buffWrite = new FileWriter("plugins/MineCart/ResgatarVIP_error.log", true);
	...
	public static void resgatarCASH(String a){
		try {
			FileWriter buffWrite = new FileWriter("plugins/MineCart/ResgatarCASH_error.log", true);
